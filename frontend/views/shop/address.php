...
<head>
    ...
    <style>
        #name-error,#phone-error,#address-error{
            color:red;
        }
    </style>
</head>
...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl>
                <dt>1.<?=$model->name?> <?=$model->province?> <?=$model->city?> <?=$model->area?> <?=$model->address?> <?=$model->phone?> </dt>
                <dd>
                    <a href="<?=\yii\helpers\Url::to(['shop/address-edit'])?>?id=<?=$model->id?>">修改</a>
                    <a href="<?=\yii\helpers\Url::to(['shop/address-del'])?>?id=<?=$model->id?>">删除</a>
                    <a href="">设为默认地址</a>
                </dd>
            </dl>
            <?php endforeach;?>
        ...
        <div class="address_bd mt10">
            <h4>新增收货地址</h4>
            <form action="<?=\yii\helpers\Url::to(['shop/address'])?>" method="post" name="address_form" id="login_form">
                <ul>
                    <li>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" id="default" name="default" class="check" />设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
